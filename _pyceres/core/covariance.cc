...
void init_covariance(py::module& m) {
  ...
  auto co = py::class_<ceres::Covariance::Options>(m, "CovarianceOptions")
                ...
                .def_readwrite("apply_loss_function", &c_options::apply_loss_function);
  make_dataclass(co);
  ...
  py::class_<ceres::Covariance>(m, "Covariance")
      ...
      .def(
          ...
          [](ceres::Covariance& self, py::array_t<double>& block1,
            ...
            bool success = self.GetCovarianceBlock(static_cast<double*>(info1.ptr),
      ...
      .def(
          ...
          [](ceres::Covariance& self, py::array_t<double>& block1,
             py::array_t<double>& block2, const ceres::Problem& problem) -> py::object {
