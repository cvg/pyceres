...
void bind_factors(py::module& m) {
  m.def("BundleAdjustmentCost", &CreateBundleAdjustmentCost, py::arg("camera_model_id"),
        py::arg("point2D"), py::arg("stddev") = 1.0);
  m.def("BundleAdjustmentCost", &CreateBundleAdjustmentConstantPoseCost,
        py::arg("camera_model_id"), py::arg("point2D"), py::arg("qvec"), py::arg("tvec"),
        py::arg("stddev") = 1.0);
  m.def("BundleAdjustmentRigCost", &CreateBundleAdjustmentRigCost,
        py::arg("camera_model_id"), py::arg("point2D"), py::arg("stddev") = 1.0);
  m.def("BundleAdjustmentRigCost", &CreateBundleAdjustmentConstantRigCost,
        py::arg("camera_model_id"), py::arg("point2D"), py::arg("rel_qvec"),
        py::arg("rel_tvec"), py::arg("stddev") = 1.0);
